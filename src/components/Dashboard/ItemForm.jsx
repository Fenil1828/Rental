    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit} className="item-form">
          ...
          <div className="form-row">
            <div className="form-group">
              <label htmlFor="rent_price" className="form-label">Rent Price (₹) *</label>
              <input
                type="number"
                id="rent_price"
                name="rent_price"
            ...
            <div className="form-group">
              <label htmlFor="rent_type" className="form-label">Price Type *</label>
              <select
                id="rent_type"
                name="rent_type"
                value={formData.rent_type}
          ...
          <div className="form-group">
            <label htmlFor="photo" className="form-label">Item Photo</label>
            <input
              type="file"
              id="photo"
              accept="image/*"
